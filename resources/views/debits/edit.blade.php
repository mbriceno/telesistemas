...
@section('title')
Orden de reembolso: {{$debit->enterprise->razon_social}}
@stop
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-lg-12">
                <h1 class="page-header">Editar reembolso: {{$debit->enterprise->razon_social}}</h1>
            </div>
            <!-- /.col-lg-12 -->
            <div class="col-xs-12 col-sm-9 col-lg-9">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-xs-6 col-sm-3 col-lg-6">
                        ...
                        {!!Form::text('fecha_debito', $debit->fecha_debito, 
                ...
                <div class="row">
                    <div class="form-group col-xs-12 col-sm-6 col-lg-6">
                        {!!Form::submit("Editar", array("class" => "btn btn-lg btn-success btn-block", "id" =>"btnSubmit"))!!}
                    </div>
                    <div class="form-group col-xs-12 col-sm-6 col-lg-6">
