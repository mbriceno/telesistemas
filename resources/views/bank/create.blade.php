    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-9 col-lg-6">
                {!! Form::open(array("method" => "POST","route" => "admin.bancos.store","role" => "form","id"=>"formid")) !!}
                    ...
                    <div class="row">
                        <div class="form-group col-xs-12 col-sm-6 col-lg-6">
                            {!!Form::submit("Agregar banco", array("class" => "btn btn-lg btn-success btn-block", "id" =>"btnSubmit"))!!}
                        </div>
                        <div class="form-group col-xs-12 col-sm-6 col-lg-6">
